...
if createOperation; then
  ...
  readParameter "KEYCLOAK_AUTHSERVERURL - Please provide the URL of the KeyCloak Authentication Server.  You MUST supply a value." KEYCLOAK_AUTHSERVERURL ""
  readParameter "KEYCLOAK_REALM - Please provide the KeyCloak Realm for the application.  You MUST supply a value." KEYCLOAK_REALM ""
  readParameter "KEYCLOAK_CLIENTID - Please provide the KeyCloak Client ID for the application.  You MUST supply a value." KEYCLOAK_CLIENTID ""
else
  # Secrets are removed from the configurations during update operations ...
  printStatusMsg "Update operation detected ...\nSkipping the prompts for KEYCLOAK_AUTHSERVERURL, KEYCLOAK_REALM, and KEYCLOAK_CLIENTID secrets ...\n"
  writeParameter "KEYCLOAK_AUTHSERVERURL" "prompt_skipped" "false"
  writeParameter "KEYCLOAK_REALM" "prompt_skipped" "false"
  writeParameter "KEYCLOAK_CLIENTID" "prompt_skipped" "false"
fi
