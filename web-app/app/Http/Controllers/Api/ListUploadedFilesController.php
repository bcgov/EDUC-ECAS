...
class ListUploadedFilesController extends Controller
{
    ...
    public function index($profile_id)
    {
        ...
        $res = $client->request('GET', $apiurl.'/ContractFiles/ListUploadedFiles?assignmentId='.$profile_id, ['auth' => [$apiusr, $apipwd]]);
